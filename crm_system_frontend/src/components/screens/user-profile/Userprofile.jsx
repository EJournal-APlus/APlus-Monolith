...
function Userprofile(){
    ...
    // useEffect(() => {
    //     const fetchData = async() => {
    //         const responce = await axios.post("https://localhost:7269/getavatar",{
    //             username: "ex@mail.ru"
    //         });
    ...
    // useEffect(() => {
    //     const fetchData = async() => {
    //         axios.get('https://localhost:7269/getavatar?username=ex@mail.ru').then(responce =>{
    //             setAvatar(responce.data);
    //             console.log(responce.data)
    //         })
    //     }
    //     fetchData()
    ...
    return(
        <div className='mainplace'>
            {email != null ? <h1>Hello, {email}</h1> : goToLogin()}
